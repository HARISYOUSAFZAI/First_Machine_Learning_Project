...
class Configuration:
    ...
    def get_data_transformation_config(self) -> DataTransformationConfig:
        try:
            ...
            transformed_test_dir= os.path.join (data_transformation_artifact_dir,
                                                data_transformation_info[DATA_TRANSFORMATION_TRANSFORMED_DIR_KEY],
                                                data_transformation_info[DATA_TRANSFORMATION_TEST_DIR_KEY])
            ...
            preprocessed_object_file_path= os.path.join(data_transformation_artifact_dir, 
                                                        ...
                                                        data_transformation_info[DATA_TRANSFORMATION_PREPROCESSED_OBJECT_PATH_KEY])
    ...
    def get_model_trainer_config(self) -> ModelTrainerConfig:
        try:
            ...
            model_train_artifact_dir = os.path.join(artifact_dir,
                                                    MODEL_TRAINER_ARTIFACT_DIR,
                                                    self.time_stamp
                                                    )
            model_trianer_config_info = self.config_info[MODEL_TRAINER_CONFIG_KEY]
            trained_model_file_path = os.path.join(model_train_artifact_dir,
                                                   model_trianer_config_info[MODEL_TRAINER_TRAINED_DIR_KEY],
                                                   model_trianer_config_info[MODEL_TRAINER_TRAINED_MODEL_FILE_NAME_KEY]
                                                   )
            model_config_file_path = os.path.join(model_trianer_config_info[MODEL_TRAINER_MODEL_CONFIG_DIR_KEY],
                                                  model_trianer_config_info[MODEL_TRAINER_CONFIG_FILE_NAME_KEY])
            base_accuracy = model_trianer_config_info[MODEL_TRAINER_BASE_ACCURACY_KEY]

            model_trainer_config = ModelTrainerConfig(trained_model_file_path= trained_model_file_path,
                                                      model_config_file_patth=model_config_file_path,
    ...
    def get_model_evaluation_config(self) -> ModelEvaluationConfig:
        try:
            ...
            model_evaluation_config_info = self.config_info[MODEL_EVALUATION_ARTIFACT_DIR]

            model_evalutation_artifact_dir = os.path.join(artifact_dir,
                                                          MODEL_EVALUATION_ARTIFACT_DIR,
                                                          self.time_stamp
                                                          )
            model_evaluation_file_path = os.path.join(model_evalutation_artifact_dir,
    ...
    def get_model_pusher_config(self) -> ModelPusherConfig:
        try:
            ...
            model_pusher_config_info = self.config_info[MODEL_PUSH_CONFIG_KEY]
            export_dir_path = os.path.join(ROOT_DIR,
                                            model_pusher_config_info[MODEL_PUSH_EXPORT_DIR_KEY],
                                            time_stamp)
